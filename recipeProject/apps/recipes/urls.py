...
urlpatterns = [
    ...
    path('<int:n>', views.show), # if GET then show page, if DELETE then delete entry
    path('<int:n>/edit', views.edit), # if GET then show edit page, if POST then update data
    ...
    path('books/<int:n>', views.showBook), # if GET then show page, if DELETE then delete entry
    path('books/<int:n>/edit', views.editBook), # if GET then show edit page, if POST then update data
